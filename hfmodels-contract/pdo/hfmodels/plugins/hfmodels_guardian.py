...
__all__ = [
    ...
    'do_hfmodels_guardian',
    'do_hfmodels_guardian_service',
    'load_commands',
]
...
class op_provision_token_issuer(pcontract.contract_op_base) :
    ...
    def add_arguments(cls, subparser) :
        ...
        subparser.add_argument(
            '-u', '--url',
            help='URL for the hfmodels guardian service',
            type=str, required=True)
...
do_hfmodels_guardian_service = pcontract.create_shell_command('hfmodels_guardian_service', __operations__)
...
do_hfmodels_guardian = pcommand.create_shell_command('hfmodels_guardian', __commands__)

## -----------------------------------------------------------------
## Enable binding of the shell independent version to a pdo-shell command
## -----------------------------------------------------------------
def load_commands(cmdclass) :
    pshell.bind_shell_command(cmdclass, 'hfmodels_guardian', do_hfmodels_guardian)
    pshell.bind_shell_command(cmdclass, 'hfmodels_guardian_service', do_hfmodels_guardian_service)